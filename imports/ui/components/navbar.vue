<template>
  <header>
    <nav
      class="flex flex-wrap items-center justify-between w-full py-4 md:py-0 px-4 text-lg text-gray-700 bg-blue-600"
    >
      <div>
      ...
      <div class="hidden w-full md:flex md:items-center md:w-auto" id="menu">
        ...
        >
          <li>
            <button
              @click="signOut"
              class="md:p-4 py-2 block hover:text-indigo-400 text-white"
